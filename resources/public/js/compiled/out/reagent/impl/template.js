...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__25140__auto__,writer__25141__auto__,opt__25142__auto__){
return cljs.core._write.call(null,writer__25141__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__27124 = o;
(G__27124[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.truth_((function (){var and__24522__auto__ = cljs.core.some_QMARK_.call(null,jsprops);
if(and__24522__auto__){
var and__24522__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__27133 = jsprops;
(G__27133["defaultValue"] = value);

(G__27133["onChange"] = ((function (G__27133,v,value,on_change){
return (function (p1__27130_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__27130_SHARP_);
});})(G__27133,v,value,on_change))
);

(G__27133["ref"] = ((function (G__27133,v,value,on_change){
return (function (p1__27131_SHARP_){
return (this$["cljsInputElement"] = p1__27131_SHARP_);
});})(G__27133,v,value,on_change))
);
...
var vec__27138 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__27138,(0),null);
var id = cljs.core.nth.call(null,vec__27138,(1),null);
var class$ = cljs.core.nth.call(null,vec__27138,(2),null);
...
var jsprops = {"argv": v};
var temp__4661__auto___27141 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___27141 == null)){
} else {
var key_27142 = temp__4661__auto___27141;
...
var G__27144 = (new reagent.impl.template.NativeWrapper());
(G__27144["name"] = c);
...
var len__25604__auto___27150 = arguments.length;
var i__25605__auto___27151 = (0);
while(true){
if((i__25605__auto___27151 < len__25604__auto___27150)){
args__25611__auto__.push((arguments[i__25605__auto___27151]));

var G__27152 = (i__25605__auto___27151 + (1));
i__25605__auto___27151 = G__27152;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__25612__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq27148){
var G__27149 = cljs.core.first.call(null,seq27148);
var seq27148__$1 = cljs.core.next.call(null,seq27148);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__27149,seq27148__$1);
});
...
break;
default:
var G__27156 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__27156;
continue;
...
var n__25449__auto___27159 = a.length;
var i_27160 = (0);
while(true){
if((i_27160 < n__25449__auto___27159)){
(a[i_27160] = reagent.impl.template.as_element.call(null,(a[i_27160])));

var G__27161 = (i_27160 + (1));
i_27160 = G__27161;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__25449__auto___27162 = a.length;
var i_27163 = (0);
while(true){
if((i_27163 < n__25449__auto___27162)){
var val_27164 = (a[i_27163]);
if((cljs.core.vector_QMARK_.call(null,val_27164)) && ((reagent.impl.template.key_from_vec.call(null,val_27164) == null))){
(o["no-key"] = true);
} else {
}

(a[i_27163] = reagent.impl.template.as_element.call(null,val_27164));
...
var ctx = {};
var vec__27167 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__27167,(0),null);
var derefed = cljs.core.nth.call(null,vec__27167,(1),null);
...
var G__27169 = (cljs.core.count.call(null,argv) - first_child);
switch (G__27169) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__27169){
...
//# sourceMappingURL=template.js.map?rel=1478192734644